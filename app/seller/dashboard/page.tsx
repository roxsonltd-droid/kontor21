...
import { Plus, CheckCircle2, X, Blocks, Wallet, ArrowUpRight, ShieldCheck, Activity, Search, FileCheck, ChevronRight, UploadCloud } from 'lucide-react';
...
export default function SellerDashboard() {
  ...
  const [trades, setTrades] = useState<SellerTrade[]>([]);
                  ...
                  <tr>
                    <td colSpan={6} className="text-center py-8 text-zinc-400">
                      <div className="flex flex-col items-center gap-3">
                        <p className="text-sm">No trades yet. Create your first smart contract.</p>
                        <button
                          onClick={() => setIsModalOpen(true)}
                        ...
                        >
                          <Plus className="w-3.5 h-3.5" /> {t('seller.newContract')}
                        </button>
                      </div>
                    </td>
                  </tr>
